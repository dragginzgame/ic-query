...
| [0.27 Bounded Official ICRC Analytics](design/0.27/0.27-design.md) | One-request ledger total-supply history with explicit off-chain authority and observation bounds |
