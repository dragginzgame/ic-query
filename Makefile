...
help:
	...
	@echo "  patch      Run release gate, bump patch version files, then clean build artifacts"
	@echo "  minor      Run release gate, bump minor version files, then clean build artifacts"
	@echo "  major      Run release gate, bump major version files, then clean build artifacts"
