...
use super::{
    ...
    proposals::{
        ...
        NNS_PROPOSAL_TOPIC_ANY_LABEL, NNS_PROPOSAL_TOPIC_GOVERNANCE_LABEL, NnsProposalCacheOptions,
        NnsProposalListOptions, NnsProposalListSort, NnsProposalOptions, NnsProposalRefreshOptions,
