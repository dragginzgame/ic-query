...
pub(in crate::nns) use report::{
    ...
    NNS_PROPOSAL_SORT_REWARD_STATUS_LABEL, NNS_PROPOSAL_SORT_TITLE_LABEL,
    ...
    NNS_PROPOSAL_TOPIC_GOVERNANCE_LABEL, NnsProposalListSort, NnsProposalRewardStatusFilter,
