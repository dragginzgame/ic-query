...
fn proposal_request(input: &str) -> SnsProposalRequest {
    SnsProposalRequest {
        network: MAINNET_NETWORK.to_string(),
        source_endpoint: DEFAULT_SNS_SOURCE_ENDPOINT.to_string(),
        now_unix_secs: 1_780_531_200,
...
fn proposals_request(input: &str) -> SnsProposalsRequest {
    SnsProposalsRequest {
        network: MAINNET_NETWORK.to_string(),
        source_endpoint: DEFAULT_SNS_SOURCE_ENDPOINT.to_string(),
        now_unix_secs: 1_780_531_200,
...
struct FixtureSnsProposalSource;
...
struct FixtureSnsProposalsSource;
