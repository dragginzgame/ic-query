...
pub fn command() -> ClapCommand {
    ClapCommand::new("nns")
        ...
        .subcommand(subnet::subnet_command())
        .subcommand(data_center::command())
        .subcommand(governance::governance_command())
        .subcommand(node::node_command())
        .subcommand(neuron::neuron_command())
        .subcommand(node_provider::command())
        .subcommand(node_operator::command())
        .subcommand(proposals::nns_proposal_command())
        .subcommand(registry::registry_command())
        .subcommand(topology::topology_command())
}
