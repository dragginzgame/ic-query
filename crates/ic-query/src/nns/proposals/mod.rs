...
pub use report::{
    ...
    NNS_PROPOSAL_REFRESH_MAX_PAGE_SIZE, NnsProposalCacheListReport, NnsProposalCacheListRequest,
    NnsProposalCacheStatusReport, NnsProposalCacheStatusRequest, NnsProposalCacheSummary,
    NnsProposalHostError, NnsProposalRefreshAttemptStatus, NnsProposalRefreshReport,
    NnsProposalRefreshRequest, NnsProposalSource, NnsProposalSourceRequest,
