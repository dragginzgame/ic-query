...
pub use report::{
    ...
    NnsProposalHostError, NnsProposalRefreshReport, build_nns_proposal_cache_list_report,
...
pub use report::{
    ...
    NnsProposalError, NnsProposalListReport, NnsProposalListRequest, NnsProposalListSort,
    ...
    NnsProposalTopicFilter, NnsProposalVote, build_nns_proposal_list_report_with_source,
