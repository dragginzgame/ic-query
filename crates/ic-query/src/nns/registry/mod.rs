...
pub use replay::{
    ...
    NnsCertifiedSubnetCatalogCacheAuthority, NnsCertifiedSubnetCatalogCacheEnvelope,
    ...
    load_nns_certified_subnet_catalog_cache, nns_certified_registry_archive_manifest_path,
