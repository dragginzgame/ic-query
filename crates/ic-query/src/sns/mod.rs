...
pub use report::{
    ...
    MainnetSnsMetrics, MainnetSnsNeuronPage, MainnetSnsNeurons, MainnetSnsProposal,
    MainnetSnsProposalPage, MainnetSnsProposals, MainnetSnsSwap, MainnetSnsToken,
    MainnetSnsUpgrade, SNS_REFRESH_MAX_PAGE_SIZE, SnsCacheListReport, SnsCacheListRequest,
    SnsCacheStatusReport, SnsCacheStatusRequest, SnsCacheSummary, SnsCanisterSource,
    SnsDiscoverySource, SnsHostError, SnsMetricsSource, SnsNeuronDissolveState, SnsNeuronId,
