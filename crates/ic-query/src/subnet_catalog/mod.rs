...
pub use host::{
    ...
    SubnetCatalogRefreshRequest, SubnetCatalogRefreshTrigger, SubnetCatalogRegistryRecordKind,
    SubnetCatalogRegistryRecordSubject, SubnetCatalogRemediation, SubnetCatalogRetryability,
