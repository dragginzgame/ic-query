...
use crate::ic::{
    ...
    IcDailyStatsQuery, IcDailyStatsRow, IcDailyStatsSourceData, IcHostError, IcMetricKind,
    IcMetricObservation, IcMetricQuery, IcMetricSeries, IcMetricSource, IcMetricSourceData,
    IcNetworkSource, IcSourceRequest,
};
...
impl IcNetworkSource for LiveIcSource {
    ...
    fn fetch_daily_stats(
        ...
        super::source::validate_daily_stats_query(query)?;
