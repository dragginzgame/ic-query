...
for generic ICRC reports, NNS registry-version and proposal list/detail
reports, deployed SNS list, info, token, governance-parameter, and proposal
list/detail reports, plus subnet catalog JSON/model/resolver helpers,
