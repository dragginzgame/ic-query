...
| NNS/SNS canisters | Native adapters expose ordinary read-only replica query responses; the `canister` adapter exposes replicated inter-canister execution for the direct NNS Governance point reports plus bounded proposal/neuron pages and exact proposal/neuron detail | Replicated execution is not certificate evidence, and paginated or sequential calls may span state changes |
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["canister"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["cloud-engine-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["cloud-engine-host", "subnet-catalog-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["dashboard-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["ic-state-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["cmc-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["icrc-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["sns-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["certified-subnet-catalog-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["nns-topology-host"] }
```
...
```toml
[dependencies]
ic-query = { version = "0.43", default-features = false, features = ["nns-host"] }
```
